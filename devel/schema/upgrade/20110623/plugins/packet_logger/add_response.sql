...
DROP FUNCTION add_response(bigint, bigint, integer, bigint, integer, integer, character varying, character varying, integer, integer, integer, integer, integer, boolean, boolean, boolean, boolean, boolean, boolean);
